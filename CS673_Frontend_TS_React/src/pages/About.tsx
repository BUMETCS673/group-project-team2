          ...
          <div style={{ padding: '40px' }}>
            <ImageBox>
              ...
              <p style={{ whiteSpace: 'break-spaces' }}>
                ...
                Development concentration.{'\n'}I completed my computer science
                engineering {'\n'}
                in 2014 and worked for the past 7 years as {'\n'}a Software
                Architect at Vantage Agora Inc.{'\n'}
          ...
          <div style={{ padding: '40px' }}>
            <ImageBox>
              ...
              <p style={{ whiteSpace: 'break-spaces' }}>
                ...
                Economics and Law in Brazil, {'\n'}
                but I wasn't passionate about any of them.{'\n'}I decided to
                give Programming a try and {'\n'}I ended up enjoying it more
                than I expected.{'\n'}
          ...
          <div style={{ padding: '40px' }}>
            <ImageBox>
              ...
              <p style={{ whiteSpace: 'break-spaces' }}>
                ...
                portfolio/blog in React with Next.js, {'\n'}
